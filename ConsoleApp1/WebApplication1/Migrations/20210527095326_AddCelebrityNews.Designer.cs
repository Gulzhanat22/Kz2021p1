...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20210527095326_AddCelebrityNews")]
    partial class AddCelebrityNews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.EfStuff.Model.Television.CelebrityNews", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("WebApplication1.EfStuff.Model.Television.CelebrityNews", b =>
                {
                    b.HasOne("WebApplication1.EfStuff.Model.Television.TvCelebrity", "Celebrity")
                        .WithOne("CelebrityNews")
                        .HasForeignKey("WebApplication1.EfStuff.Model.Television.CelebrityNews", "CelebrityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication1.EfStuff.Model.Television.TvProgramme", "Programme")
                        .WithOne("CelebrityNews")
                        .HasForeignKey("WebApplication1.EfStuff.Model.Television.CelebrityNews", "ProgrammeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
